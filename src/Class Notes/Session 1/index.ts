...
let employeeName: string[] = ["Abigail", "Joseph", "Valerie", "John"]
let yearJoined: number[] = [2000, 2010, 2015, 2020]
...
let hobbies: string[] = ["swimming", "jogging", "knitting.",]
let year: number[] = [10, 12, 20, 25]
